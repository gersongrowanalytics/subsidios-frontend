        ...
        return (
            <div id="Contenedor-TarjetaCargaArchivo" >
                ...
                <div 
                    ...
                    style={
                        this.props.ComunesTipoDisenio == "Light"
                        ?{boxShadow: "0px 0px 15px #D8DFE9", paddingBottom:'5px'}
                        :{boxShadow: "0px 4px 4px rgba(0, 0, 0, 0.25)"}
                    }
                >
                    <div id="PrimeraParte-Contenedor-Tarjeta-TarjetaCargaArchivo" style={{paddingTop:'25px'}}>
                    ...
                    >

                        {
                            ...
                            :<Row style={{alignItems: "center"}}>
                                ...
                                <Col xl={16} md={24} sm={16} xs={16} style={{marginLeft:'-5px',}}>
                                    <span 
